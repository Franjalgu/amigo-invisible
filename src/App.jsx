    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        @media(max-width:480px){.R.wrap{flex-direction:column}}
            ...
            <div className="K">
              ...
              <div className="R wrap">
                <div className="fg" style={{flex:1}}>
                  ...
                  <input type="date" value={eventDate} onChange={e=>setEventDate(e.target.value)} onClick={e=>e.target.showPicker?.()}/>
                </div>
                <div className="fg" style={{flex:1}}>
